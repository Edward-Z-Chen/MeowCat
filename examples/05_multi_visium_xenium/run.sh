...
# prepare-visium (Step 3.5) builds embeddings-hist for VIS samples only, so the
# XEN samples need their dense [H,W,C] embeddings-hist grid built here for
# full-grid prediction. Converts single_super_emb.h5ad -> embeddings-hist.pickle.
# ---------------------------------------------------------------------------
